...
import { NodeVisitor, NodeVisitorEqual, NodeVisitorGreaterThan, NodeVisitorGreaterThanOrEqual, NodeVisitorLessThan, NodeVisitorLessThanOrEqual } from "./trees";
...
export class GreaterThanOrEqualFilter<A extends Value> extends Filter<A> {
	private value: A;
	...
	createNodeVisitor(key_nibbles: Array<number>): NodeVisitor {
		return new NodeVisitorGreaterThanOrEqual(key_nibbles);
	}

...
exports.RLECompressor = void 0;
function compress_data_using_rle_coding(source) {
...
;
function decompress_data_using_rle_coding(source, target) {
    let source_offset = 0;
    let target_offset = 0;

...
export declare function createGreaterThanOrEqualFilter<A extends Value>(value: A): GreaterThanOrEqualFilter<A>;
export declare function createLessThanFilter<A extends Value>(value: A): LessThanFilter<A>;
export declare function createLessThanOrEqualFilter<A extends Value>(value: A): LessThanOrEqualFilter<A>;

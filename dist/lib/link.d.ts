...
export declare type ReadableLinks = {
    [key: string]: ReadableLink<any, any, any, any, any>;
};
export declare type ReadableLinksFromLinks<A extends Links> = {
    [B in keyof A]: A[B] extends Link<infer C, infer D, infer E, infer F, infer G> ? ReadableLink<C, D, E, F, G> : never;
};
export declare type LinksFromReadableLinks<A extends ReadableLinks> = {
...
export declare type WritableLinks = {
    [key: string]: WritableLink<any, any, any, any, any>;
};
export declare type WritableLinksFromLinks<A extends Links> = {
    [B in keyof A]: A[B] extends Link<infer C, infer D, infer E, infer F, infer G> ? WritableLink<C, D, E, F, G> : never;
};
export declare type LinksFromWritableLinks<A extends WritableLinks> = {
...
export declare type LinkManagers = {
    [key: string]: LinkManager<any, any, any, any, any>;
};
export declare type LinkManagersFromLinks<A extends Links> = {
